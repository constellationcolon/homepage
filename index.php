...
<div class="container-fluid" id="container">
    ...
    <div class="row" id="events-wrap">
        ...
        <button type="button" class="btn btn-block btn-lg btn-info btn-open collapsed" data-toggle="collapse"
                data-target="#events-all">
            <span class="past-btn">SEE PAST EVENTS <span class="glyphicon glyphicon-chevron-down"
    ...
    <div class="row" id="resources-wrap">
        <div id="resources-overlay">
            ...
            <div class="input-group input-group-lg" id="resources-bar">
                <input type="text" id="resources-text" class="form-control search-text"
